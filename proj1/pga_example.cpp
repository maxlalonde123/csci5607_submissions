...
int main(int argc, char *argv[]){
  ...
  cout << "\nMultiplication:" << endl;
  MultiVector t1 = MultiVector(Rotator2D(3.14159/2, Point2D(0,0))); // Motor for 90 degree rotation around origin
  Point2D p5 = Point2D(t1*MultiVector(p1)*t1.reverse()); // Rotate p1 by 90 degrees around origin using sandwich product
  cout << "Sandwich product - t p t~ : " << string(p5) << endl;
